 ...
 *
 *   ./image_to_code.py -i src/ImageResources/FBFriendPickerView/FBFriendPickerViewDefault.png -c FBFriendPickerViewDefault -o src/ImageResources/FBFriendPickerView
 *
 */
